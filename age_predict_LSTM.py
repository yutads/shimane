...
from my_def import train_model_LSTM
...
param_LSTM_ROI1 = cfg.param_LSTM_ROI1
param_LSTM_ROI2 = cfg.param_LSTM_ROI2
param_LSTM_dFC1 = cfg.param_LSTM_dFC1
param_LSTM_dFC2 = cfg.param_LSTM_dFC2
...
np.savez(f'../02_data_analysis/temp/{s}_lstm',
         test_pred_1,
         test_pred_corrected_1,
         test_label_1,
         test_idx_1)

np.savez(f'../02_data_analysis/temp/{s}_lstm_bi',
         test_pred_2,
         test_pred_corrected_2,
         test_label_2,
         test_idx_2)
...
np.savez(f'../02_data_analysis/temp/dynamic_lstm_{s}',
         test_pred_dynamic_1,
         test_pred_dynamic_corrected_1,
         test_label_dynamic_1,
         test_idx_dynamic_1)
np.savez(f'../02_data_analysis/temp/dynamic_lstm_{s}_bi',
         test_pred_dynamic_2,
         test_pred_dynamic_corrected_2,
         test_label_dynamic_2,
         test_idx_dynamic_2)

np.savez(f'../02_data_analysis/temp/{s}_lstm_dynamic',
         test_pred_dynamic_1,
         test_pred_dynamic_corrected_1,
         test_label_dynamic_1,
         test_idx_dynamic_1)
np.savez(f'../02_data_analysis/temp/{s}_lstm_dynamic_bi',
         test_pred_dynamic_2,
         test_pred_dynamic_corrected_2,
         test_label_dynamic_2,
         test_idx_dynamic_2)